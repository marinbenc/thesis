...
% Thesis information
\thesistitle{Data Efficient Deep Learning Models for Biomedical Image Segmentation} % Your thesis title, print it elsewhere with \ttitle
...
\degree{Doctoral Dissertation} % Your degree name, print it elsewhere with \degreename
...
\supervisor{prof. Irena Galić, prof. Aleksandra Pižurica, dr. Danilo Babin} % Your supervisor's name, print it elsewhere with \supname
...
% ------ BIBLIOGRAPHY ------
\usepackage[backend=biber,style=alphabetic,natbib=true, maxbibnames=5,minbibnames=5]{biblatex}
...
% Include abstract page
\input{Base/abstract-nl.tex}

% Include abstract page
\input{Base/abstract-hr.tex}
...
\begin{refsection}
\include{Chapters/05_input_size_reduction}
\printbibliography[heading=subbibintoc]
\end{refsection}

\begin{refsection}
\include{Chapters/06_other_methods}
\printbibliography[heading=subbibintoc]
\end{refsection}
